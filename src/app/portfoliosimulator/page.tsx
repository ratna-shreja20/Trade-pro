...
const detectCandlestickPatterns = (dailyData: Stock['dailyData']): CandlestickPattern[] => {
  ...
  for (let i = 2; i < dailyData.length; i++) {
    ...
    const yesterdayUpperShadow = yesterday.high - Math.max(yesterday.open, yesterday.close);
    const yesterdayLowerShadow = Math.min(yesterday.open, yesterday.close) - yesterday.low;
